...
- **Tableau Dashboards** – Visualize portfolio trends and KPIs for leadership.
- **SQL Reporting Samples** – Queries showing joins, trends, and variance logic.

**Tools:** Python, pandas, SQL, Tableau, Excel, Power BI, Anaplan, Workday ERP.
